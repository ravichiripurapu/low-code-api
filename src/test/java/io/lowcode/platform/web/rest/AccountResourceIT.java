...
import io.lowcode.platform.web.rest.vm.KeyAndPasswordVM;
import io.lowcode.platform.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testGetExistingAccount() throws Exception {
        ...
        restAccountMockMvc
            ...
            .andExpect(jsonPath("$.email").value("john.doe@abc.com"))
