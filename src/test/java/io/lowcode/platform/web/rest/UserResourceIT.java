...
import io.lowcode.platform.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    private static final String UPDATED_LOGIN = "ravichiripurapu";

    private static final Long DEFAULT_ID = 1L;

    private static final String DEFAULT_EMAIL = "johndoe@localhost";
    private static final String UPDATED_EMAIL = "rchiripurapu@localhost";

    private static final String DEFAULT_FIRSTNAME = "john";
    private static final String UPDATED_FIRSTNAME = "Ravi";

    private static final String DEFAULT_LASTNAME = "doe";
    private static final String UPDATED_LASTNAME = "Chiripurapu";
    ...
    void updateUserExistingEmail() throws Exception {
        ...
        anotherUser.setLogin("ravi");
        anotherUser.setPassword(RandomStringUtils.insecure().nextAlphanumeric(60));
        anotherUser.setActivated(true);
        anotherUser.setEmail("ravi@localhost");
        anotherUser.setFirstName("ravi");
        anotherUser.setLastName("chiripurapu");
        ...
        userDTO.setEmail("ravi@localhost"); // this email should already be used by anotherUser
        userDTO.setActivated(updatedUser.isActivated());
    ...
    void updateUserExistingLogin() throws Exception {
        ...
        AdminUserDTO userDTO = new AdminUserDTO();
        userDTO.setId(updatedUser.getId());
        userDTO.setLogin("ravi"); // this login should already be used by anotherUser
        userDTO.setFirstName(updatedUser.getFirstName());
        userDTO.setLastName(updatedUser.getLastName());
