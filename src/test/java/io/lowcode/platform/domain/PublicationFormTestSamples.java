...
public class PublicationFormTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static PublicationForm getPublicationFormSample1() {
    ...
    public static PublicationForm getPublicationFormSample2() {
        return new PublicationForm()
            .id(2L)
    ...
    public static PublicationForm getPublicationFormRandomSampleGenerator() {
        return new PublicationForm()
