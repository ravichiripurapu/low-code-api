...
public class DocumentDataAsserts {
     ...
     */
    public static void assertDocumentDataAllPropertiesEquals(DocumentData expected, DocumentData actual) {
        assertDocumentDataAutoGeneratedPropertiesEquals(expected, actual);
        assertDocumentDataAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertDocumentDataAllUpdatablePropertiesEquals(DocumentData expected, DocumentData actual) {
        assertDocumentDataUpdatableFieldsEquals(expected, actual);
        assertDocumentDataUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertDocumentDataAutoGeneratedPropertiesEquals(DocumentData expected, DocumentData actual) {
        assertThat(actual)
            .as("Verify DocumentData auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertDocumentDataUpdatableFieldsEquals(DocumentData expected, DocumentData actual) {
        assertThat(actual)
            .as("Verify DocumentData relevant properties")
     ...
     * @param actual the actual entity
     */
    public static void assertDocumentDataUpdatableRelationshipsEquals(DocumentData expected, DocumentData actual) {
        // empty method
    }
}
