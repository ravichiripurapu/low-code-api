...
public class PublicationFormDataTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static PublicationFormData getPublicationFormDataSample1() {
    ...
    public static PublicationFormData getPublicationFormDataSample2() {
        return new PublicationFormData()
            .id(2L)
            .idFormVersion(2L)
            .idFormParent(2L)
    ...
    public static PublicationFormData getPublicationFormDataRandomSampleGenerator() {
        return new PublicationFormData()
