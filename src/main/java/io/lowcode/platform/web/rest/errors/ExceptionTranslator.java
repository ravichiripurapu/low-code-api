...
import io.lowcode.platform.web.rest.HeaderUtil;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof io.lowcode.platform.service.UsernameAlreadyUsedException
        ) return (ProblemDetailWithCause) new LoginAlreadyUsedException().getBody();
        if (
            ex instanceof io.lowcode.platform.service.EmailAlreadyUsedException
        ) return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
        if (
            ex instanceof io.lowcode.platform.service.InvalidPasswordException
    ...
    private String getCustomizedErrorDetails(Throwable err) {
        ...
        if (activeProfiles.contains(LowCodeAppConfigConstants.SPRING_PROFILE_PRODUCTION)) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "io.lowcode.platform");
    }
}
