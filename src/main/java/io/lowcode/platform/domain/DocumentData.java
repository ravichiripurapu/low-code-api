...
public class DocumentData implements Serializable {
    ...
    public DocumentData idFormVersion(Long idFormVersion) {
    ...
    public DocumentData idFormParent(Long idFormParent) {
    ...
    public DocumentData fieldLabel(String fieldLabel) {
    ...
    public DocumentData fieldType(String fieldType) {
    ...
    public DocumentData fieldName(String fieldName) {
    ...
    public DocumentData fieldId(String fieldId) {
    ...
    public DocumentData fieldClass(String fieldClass) {
    ...
    public DocumentData fieldPlaceholder(String fieldPlaceholder) {
    ...
    public DocumentData fieldOptions(String fieldOptions) {
    ...
    public DocumentData fieldConfigs(String fieldConfigs) {
    ...
    public DocumentData orderPosition(Integer orderPosition) {
    ...
    public DocumentData validationConfigs(String validationConfigs) {
    ...
    public DocumentData errorMessage(String errorMessage) {
    ...
    public DocumentData flagRequired(Boolean flagRequired) {
    ...
    public DocumentData flagActive(Boolean flagActive) {
    ...
    public DocumentData createUser(String createUser) {
    ...
    public DocumentData createdAt(ZonedDateTime createdAt) {
    ...
    public DocumentData updateUser(String updateUser) {
    ...
    public DocumentData updatedAt(ZonedDateTime updatedAt) {
    ...
    public DocumentData value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public DocumentData alternativeValue(String alternativeValue) {
    ...
    public DocumentData uuid(String uuid) {
        this.setUuid(uuid);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((DocumentData) o).getId());
    }
