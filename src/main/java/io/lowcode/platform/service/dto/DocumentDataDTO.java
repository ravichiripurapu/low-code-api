...
/**
 * A DTO for the {@link io.lowcode.platform.domain.DocumentData} entity.
 */
...
public class DocumentDataDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DocumentDataDTO)) {
            return false;
        }

        DocumentDataDTO documentDataDTO = (DocumentDataDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, documentDataDTO.id);
    }
